...
=head2 map3($optA, $optB, $optC, $f) : $opt
...
=head2 map4($optA, $optB, $optC, $optD, $f) : $opt
...
=head3 bind3($optA, $optB, $optC, $f) : $opt
...
=head3 bind4($optA, $optB, $optC, $optD, $f) : $opt
