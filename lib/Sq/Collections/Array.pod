...
This function returns C<$array> as-is. So you can immediately chain another
method after calling C<push>. It also can help in some other functions that
expect you to return a value.
