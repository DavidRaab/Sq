...
Variables that start with C<$f_> are functions.
    ...
    keep_ok          ($array, $array_of_results)
    keep_ok_by       ($array, $f_result)
    keep_some        ($array, $array_of_opt)
    keep_some_by     ($array, $f)
    ...
    length           ($array)
    map              ($array, $f)
    map2             ($arrayA, $arrayB, $f)
    map3             ($arrayA, $arrayB, $arrayC, $f)
    map4             ($arrayA, $arrayB, $arrayC, $arrayD, $f)
    mapi             ($array, $f)
    mapn             ($array, $count, $f)
