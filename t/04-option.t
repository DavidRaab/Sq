...
# all_valid & filter_valid
{
    ...
    is(
        Array->all_valid($invalid),
        None,
        'all_valid with None');

    is(
        Array->filter_valid($invalid),
        [10,3,42],
